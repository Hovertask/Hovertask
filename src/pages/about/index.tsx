    ...
    return (
        <div>
            <section className="hero">
                ...
                <div className="w-full max-w-[1223.5px] max-[1255px]:p-4 mx-auto bg-[#e9edfe] rounded-[44.5px] px-8 transform rotate-[-2deg] p-12 mb-36">
                ...
                <div className="w-full flex justify-center gap-14 max-md:gap-0 items-center max-w-[1223.5px] mx-auto mb-36">
                    <img
                ...
                <div className="w-full mb-18 space-y-18  max-w-[1223px] mx-auto max-[1255px]:p-4">
                    <div className="max-w-[887.1px] w-full">
                        ...
                        <div className="shadow-lg p-6 shadow-gray-200 bg-[#EEF0FF] rounded-3xl flex justify-center gap-14 items-center max-m px-2 text-2xl font-light">
                    ...
                    <div className="max-w-[887.1px] w-full float-right">
                        ...
                        <div className="shadow-lg p-6 shadow-gray-200 bg-[#00B3060D] rounded-3xl flex justify-center gap-14 items-center max-md:w-full px-2 text-2xl font-light">
