          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            <div className="space-y-1 col-span-9">
              ...
              <p className="text-sm text-[#000000BF]">
                Experience crystal-clear sound with our Wireless Bluetooth Earbuds. Designed with advanced
                noise-cancellation technology, these earbuds deliver superior audio quality whether you're listening to
                music, taking calls, or working out.
              </p>
